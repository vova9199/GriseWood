"""
Django settings for GriseWood project.
...
SECRET_KEY = 'django-insecure-s-7plsj4&7$*qc$ot7bf^=7g_23$=496xd%nzf)w-qr4$n*xc('
...
WSGI_APPLICATION = 'GriseWood.wsgi.application'
